...
和 LLM 打交道的朋友无论如何都绕不过 special tokens 和 chat template 这两个概念。说来神奇，既然是每天打交道的概念，总该有很好的参考资料吧，但是反而我和朋友在尝试写这篇文档的时候，四处寻找，能找到比较详细的资料只有 HuggingFace 零星的文档。我们在这里把零星的资料拼接起来，分析 special tokens 和 chat template 的作用。如果处理不好 special tokens 和 chat template，无论是 training 还是 inference，模型的 performance 都会受到极大影响，令人惊异的是，即便影响巨大，居然也没有很好的博客来讲这事，我们希望能够填补这一空缺。
